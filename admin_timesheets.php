...
.topbar a:hover { background: rgba(255, 193, 7, 0.15) !important; color: #ffda6a !important; }
...
.tbl-outer { position: relative; padding: 0 20px 25px 20px; }
    ...
    <form id="bulk-form" method="POST" action="admin_timesheets.php">
        ...
        <div class="card">
            ...
            <table id="main-table">
                <thead>
                    <tr class="sec-row">
                        <th class="chk-col s-base" rowspan="2" style="z-index:26;"><input type="checkbox" id="chk-all" onchange="toggleAll(this)"></th>
                ...
                <tbody>
                <tr id="empty-row" class="is-hidden"><td colspan="10" style="text-align:center;padding:40px;color:#9ca3af;">No matching logs found.</td></tr>
