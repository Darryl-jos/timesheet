...
// 辅助函数：用来获取当前项目对应的 Actual Timeline 数据
...
// 检查是否是通过前端的 Filter/Selection 传过来的 IDs
...
echo "\xEF\xBB\xBF"; // 加上 BOM 确保 Excel 打开中文或特殊符号不乱码
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <tbody>
            ...
            if ($result && $result->num_rows > 0):
                while($row = $result->fetch_assoc()):
                    ...
                    // Actual End Date 逻辑: 只有 Completed 才显示
                    $d_act_end  = '-';
            ...
            ?>
                <tr>
                    <td class="text-bold"><?php echo htmlspecialchars($row['project_id']); ?></td>
                    ...
                    <td><?php echo !empty($row['has_project_mgmt']) ? 'Yes' : 'No'; ?></td>
