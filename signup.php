...
<div class="card">
    ...
    <form method="POST">
        ...
        <input type="text" name="username_id" placeholder="Username" required value="<?php echo isset($_POST['username_id']) ? htmlspecialchars($_POST['username_id']) : ''; ?>" style="margin-bottom:10px;">
